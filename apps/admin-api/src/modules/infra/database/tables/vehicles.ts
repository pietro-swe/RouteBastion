import { pgTable, uuid, text, doublePrecision, timestamp, index, uniqueIndex } from "drizzle-orm/pg-core";
import { cargoKindEnum } from "../enums";
...
export const vehicles = pgTable(
  ...
  (table) => [
    ...
    uniqueIndex(
      "idx_unique_vehicles_customer_id_plate"
    ).on(table.customerId, table.plate),
  ]
);
