CREATE TYPE "public"."admin_status" AS ENUM('ACTIVE', 'BLOCKED');--> statement-breakpoint
...
CREATE TABLE "admins" (
	...
	"is_password_creation_pending" boolean DEFAULT true NOT NULL,
...
ALTER TABLE "provider_access_methods" ADD CONSTRAINT "provider_access_methods_provider_id_providers_id_fk" FOREIGN KEY ("provider_id") REFERENCES "public"."providers"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "provider_constraints" ADD CONSTRAINT "provider_constraints_provider_id_providers_id_fk" FOREIGN KEY ("provider_id") REFERENCES "public"."providers"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "provider_features" ADD CONSTRAINT "provider_features_provider_id_providers_id_fk" FOREIGN KEY ("provider_id") REFERENCES "public"."providers"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_provider_access_methods_provider_id" ON "provider_access_methods" USING btree ("provider_id");--> statement-breakpoint
CREATE INDEX "idx_provider_constraints_provider_id" ON "provider_constraints" USING btree ("provider_id");--> statement-breakpoint
CREATE INDEX "idx_provider_features_provider_id" ON "provider_features" USING btree ("provider_id");--> statement-breakpoint
